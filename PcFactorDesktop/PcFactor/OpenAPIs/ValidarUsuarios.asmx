...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/ValidarUsuarios.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">ValidarUsuarios</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="ValidarUsuarios.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="ValidarUsuarios.asmx?op=Eliminar">Eliminar</a>
              ...
              <li>
                <a href="ValidarUsuarios.asmx?op=ValidarUsuario">ValidarUsuario</a>
